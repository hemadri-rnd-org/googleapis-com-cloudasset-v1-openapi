...
func Cloudasset_savedqueries_createHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		if val, ok := args["savedQueryId"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("savedQueryId=%v", val))
		}
...
func CreateCloudasset_savedqueries_createTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_parent_savedQueries",
		mcp.WithDescription("Creates a saved query in a parent project/folder/organization."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Cloudasset_savedqueries_createHandler(cfg),
	}
}
